...
// the raw reference key (model/feature/work_surface_ref.go). face.calculateFacets, by
// contrast, resolves the RAW key bytes — so a selection reference must be decoded before
// it is used to address a face.
